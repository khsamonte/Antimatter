...
class AboutScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Game Info Summary
    this.aboutInfo = this.add.text(0, 0, this.aboutInfoTxt, this.textConfig);
    this.aboutInfo.setOrigin(0, 0.1);
